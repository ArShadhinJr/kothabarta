...
const NotificationBox = () => {
  return (
    <div className="md:w-full md:h-9/10 h-screen md:my-0 my-[54px] overflow-hidden bg-white border rounded-[20px] px-[40px] py-[10px] drop-shadow-lg">
      ...
      <div className="overflow-auto h-11/12 no-scrollbar py-2 ">
        <Inner classNameImg="md:w-[50px] w-[45px]" src="https://cdn-icons-png.flaticon.com/512/149/149071.png" name="No Notification" dec="View all"></Inner>
        <Inner classNameImg="md:w-[50px] w-[45px]" src="https://cdn-icons-png.flaticon.com/512/149/149071.png" name="No Notification" dec="View all"></Inner>
        <Inner classNameImg="md:w-[50px] w-[45px]" src="https://cdn-icons-png.flaticon.com/512/149/149071.png" name="No Notification" dec="View all"></Inner>
        <Inner classNameImg="md:w-[50px] w-[45px]" src="https://cdn-icons-png.flaticon.com/512/149/149071.png" name="No Notification" dec="View all"></Inner>
        <Inner classNameImg="md:w-[50px] w-[45px]" src="https://cdn-icons-png.flaticon.com/512/149/149071.png" name="No Notification" dec="View all"></Inner>
